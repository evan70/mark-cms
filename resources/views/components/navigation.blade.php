<nav class="fixed top-0 w-full bg-transparent backdrop-blur-sm shadow-lg z-50">
    <div class="container mx-auto px-4">
        <div class="flex justify-between items-center h-16">
            <!-- Logo -->
            <a href="/{{ $language ?? 'en' }}" class="text-xl font-bold">
            ...
            <div class="hidden md:flex items-center space-x-8">
                ...
                <a href="/{{ $language }}/articles" class="nav-link">
                    {{ __('Articles') }}
                </a>
        ...
        <div class="md:hidden hidden" id="mobile-menu">
            <div class="px-2 pt-2 pb-3 space-y-1 bg-gray-900/50 backdrop-blur-sm rounded-lg mt-2">
                <a href="/{{ $language }}" class="block px-3 py-2 rounded-md hover:bg-gray-700">
                    {{ __('Home') }}
                </a>
                <a href="/{{ $language }}/articles" class="block px-3 py-2 rounded-md hover:bg-gray-700">
                    {{ __('Articles') }}
                </a>
