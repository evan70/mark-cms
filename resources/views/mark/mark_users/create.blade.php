...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold">Create Mark User</h1>
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden p-6">
        <form action="{{ url('/mark/mark-users/create') }}" method="POST">
            {!! csrf_fields() !!}
            ...
            <div class="mb-4">
                ...
                <select name="role" id="role" 
                    ...
                    <option value="editor" {{ (isset($data['role']) && $data['role'] === 'editor') ? 'selected' : '' }}>Editor</option>
                    <option value="contributor" {{ (isset($data['role']) && $data['role'] === 'contributor') ? 'selected' : '' }}>Contributor</option>
                </select>
