...
<head>
    ...
    <title>Mark CMS Admin Dashboard</title>
        ...
        <nav class="bg-gray-800 border-b border-gray-700">
                ...
                <div class="flex items-center justify-between h-16">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <span class="text-xl font-bold text-white">Mark CMS Admin</span>
                        </div>
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                <a href="/mark/admin/dashboard" class="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium">Admin Dashboard</a>
                                <a href="/mark/dashboard" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Mark Dashboard</a>
                                ...
                                <a href="/mark/users" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Users</a>
                                <a href="/mark/mark-users" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Mark Users</a>
                            </div>
                        </div>
                    </div>
                    <div class="hidden md:block">
            ...
            <div class="md:hidden" id="mobile-menu">
                <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                    <a href="/mark/admin/dashboard" class="bg-gray-900 text-white block px-3 py-2 rounded-md text-base font-medium">Admin Dashboard</a>
                    <a href="/mark/dashboard" class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Mark Dashboard</a>
                    ...
                    <a href="/mark/users" class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Users</a>
                    <a href="/mark/mark-users" class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Mark Users</a>
                </div>
            ...
            <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
                <div class="px-4 py-6 sm:px-0">
                    <div class="border-4 border-dashed border-gray-700 rounded-lg p-4 h-96">
                        <h1 class="text-2xl font-bold mb-4">Welcome to Admin Dashboard, {{ $user->name }}!</h1>
                        <p class="text-gray-300 mb-4">You are logged in as an {{ ucfirst($user->role) }}.</p>
                        
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                            <div class="bg-gray-800 p-4 rounded-lg shadow">
                                <h2 class="text-xl font-semibold mb-2">User Management</h2>
                                <p class="text-gray-400">Manage regular users of the system.</p>
                                <a href="/mark/users" class="mt-4 inline-block px-4 py-2 bg-purple-600 text-white rounded hover:bg-purple-700">Manage Users</a>
                            </div>
                            
                            <div class="bg-gray-800 p-4 rounded-lg shadow">
                                <h2 class="text-xl font-semibold mb-2">Mark User Management</h2>
                                <p class="text-gray-400">Manage Mark CMS users and their permissions.</p>
                                <a href="/mark/mark-users" class="mt-4 inline-block px-4 py-2 bg-purple-600 text-white rounded hover:bg-purple-700">Manage Mark Users</a>
                            </div>
                            
                            <div class="bg-gray-800 p-4 rounded-lg shadow">
                                <h2 class="text-xl font-semibold mb-2">System Settings</h2>
                                <p class="text-gray-400">Configure system settings and preferences.</p>
                                <a href="/mark/settings" class="mt-4 inline-block px-4 py-2 bg-purple-600 text-white rounded hover:bg-purple-700">System Settings</a>
                            </div>
                        </div>
                    </div>
                </div>
