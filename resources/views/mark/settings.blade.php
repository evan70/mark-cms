            ...
            <div class="mb-6">
                ...
                <div class="flex space-x-4">
                    <label class="inline-flex items-center">
                        <input type="radio" name="layout" value="mark.layouts.app" class="form-radio h-5 w-5 text-purple-600" {{ session('layout_preference', 'mark.layouts.app') === 'mark.layouts.app' ? 'checked' : '' }}>
                        <span class="ml-2 text-gray-300">Top Navigation</span>
                    </label>
                    <label class="inline-flex items-center">
                        <input type="radio" name="layout" value="mark.layouts.side-menu" class="form-radio h-5 w-5 text-purple-600" {{ session('layout_preference') === 'mark.layouts.side-menu' ? 'checked' : '' }}>
