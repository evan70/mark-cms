        ...
        <div class="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between">
            <div class="md:w-1/2 mb-10 md:mb-0" data-animation="slideRight">
                ...
                <div class="flex gap-4">
                    <a href="/<?php echo e($language); ?>/contact" class="btn-primary bg-purple-600 hover:bg-purple-700">
                        Začnime spoluprácu
                    </a>
                    <a href="/<?php echo e($language); ?>/portfolio" class="btn-secondary border border-purple-600 hover:bg-purple-600/10">
                        Naše projekty
                    </a>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="service-card" data-animation="slideUp" data-delay="0">
                    <div class="bg-gray-800 rounded-xl p-6 h-full border border-purple-500/20 hover:border-purple-500/50 transition-all">
                        ...
                        <p class="text-gray-400">Moderné webové aplikácie postavené na najnovších technológiách s dôrazom na výkon a škálovateľnosť.</p>
                    </div>
                </div>
                ...
                <div class="service-card" data-animation="slideUp" data-delay="0.2">
                    <div class="bg-gray-800 rounded-xl p-6 h-full border border-blue-500/20 hover:border-blue-500/50 transition-all">
                        ...
                        <p class="text-gray-400">Natívne a cross-platform mobilné aplikácie pre iOS a Android s intuitívnym používateľským rozhraním.</p>
                    </div>
                </div>
                ...
                <div class="service-card" data-animation="slideUp" data-delay="0.4">
                    <div class="bg-gray-800 rounded-xl p-6 h-full border border-green-500/20 hover:border-green-500/50 transition-all">
                        ...
                        <p class="text-gray-400">Automatizácia, monitoring a správa cloudovej infraštruktúry pre maximálnu dostupnosť vašich aplikácií.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div class="space-y-6">
                <div class="flex items-center justify-between mb-8">
                    <h2 class="text-3xl font-bold" data-animation="fadeIn"><?php echo e(__('Latest Articles')); ?></h2>
                    <a href="/<?php echo e($language); ?>/articles" 
                ...
                <?php $__currentLoopData = $latestArticles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if($translation): ?>
                        <div class="bg-gray-800 rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 border border-purple-500/10 hover:border-purple-500/30"
                             data-animation="slideUp" data-delay="<?php echo e($loop->iteration * 0.1); ?>">
                                    ...
                                    <div class="md:w-1/3">
                                        <img src="<?php echo e(str_starts_with($article->featured_image, '/uploads/') 
                                            ...
                                            : '/uploads/' . $article->featured_image); ?>" 
                                             alt="<?php echo e($translation->title); ?>"
            ...
            <div class="space-y-6">
                <div class="flex items-center justify-between mb-8">
                    <h2 class="text-3xl font-bold" data-animation="fadeIn"><?php echo e(__('Categories')); ?></h2>
                    <a href="<?php echo e($baseUrl); ?>/<?php echo e($language); ?>/categories" 
                       class="text-purple-400 hover:text-purple-300 flex items-center gap-2 group">
                        <?php echo e(__('View All')); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/evan/Desktop/slim4/mark/resources/views/home.blade.php ENDPATH**/ ?>