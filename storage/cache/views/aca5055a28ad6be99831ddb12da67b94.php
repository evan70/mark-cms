<div class="relative language-switcher" x-data="{ open: false }">
    ...
    <button @click="open = !open" 
        ...
        <img src="<?php echo e(asset('images/flags/' . $lang . '.svg')); ?>" 
             alt="<?php echo e(strtoupper($lang)); ?>" 
             class="w-5 h-5">
        <span class="language-text"><?php echo e(__('languages.' . $lang)); ?></span>
    ...
    <div x-show="open" 
        ...
        <div class="py-1">
            <?php $__currentLoopData = config('app.available_languages'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($code !== $lang): ?>
                    <a href="/<?php echo e($code); ?>" 
                       class="language-option flex items-center space-x-3 px-4 py-2 text-sm text-gray-300 hover:bg-gray-600">
                        <img src="<?php echo e(asset('images/flags/' . $code . '.svg')); ?>" 
                             alt="<?php echo e(strtoupper($code)); ?>" 
                             class="w-5 h-5">
                        <span><?php echo e(__('languages.' . $code)); ?></span>
                    </a>
                <?php endif; ?>
...
<?php /**PATH /home/evan/Desktop/slim4/mark/resources/views/components/language-switcher.blade.php ENDPATH**/ ?>